      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <img className="h-10" src="/logo.svg" alt="DevsOnLoop" />
            <p className="text-gray-500 dark:text-gray-400 text-base">
              Empowering developers to connect, learn, and grow together.
            </p>
            <div className="flex space-x-6">
              <SocialIcon href="https://instagram.com" icon={(props) => (
              ...
              <SocialIcon href="https://linkedin.com" icon={(props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
              ...
              <SocialIcon href="https://discord.com" icon={(props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                  <path fillRule="evenodd"
